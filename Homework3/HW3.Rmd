...
```{r echo=FALSE, message=FALSE, warning=FALSE}
data.corr <- cor(cp_data, use="pairwise.complete.obs")
...
--------------------------------------------
Why do you want to eleminate the last colomun. I think we need to eleminate the chas variable since it is not correlated. 
-----------------------------------------
